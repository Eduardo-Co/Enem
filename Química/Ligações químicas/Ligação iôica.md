- **Definição:** resulta da **transferência de elétrons** de um metal (baixa eletronegatividade) para um ametal (alta eletronegatividade), formando **cátions (+)** e **ânions (–)** que se atraem eletrostaticamente.
